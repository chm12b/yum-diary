...
type RenameDisplayNameSheetProps = {
  open: boolean;
  currentName: string;
  submitting: boolean;
  onClose: () => void;
...
export default function RenameDisplayNameSheet({
  open,
  currentName,
  submitting,
  onClose,
  onSave,
}: RenameDisplayNameSheetProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center">
      ...
      <div
        role="dialog"
        aria-modal="true"
        aria-labelledby="rename-display-name-title"
